...
<template>
  <div class="p-2 m-2">
    <div @dragenter="startDragAnimation($event)" @drop="stopDragAnimation"
      class="group h-28 bg-gray-50 rounded-md border-solid border-2 border-gray-500 border-dashed">
    ...
    <div class="m-full">
      ...
      <div class="bg-slate-400 shadow-md rounded px-3 pt-4 pb-1 ">
        <div class="mb-2">
          <input
            ...
            id="blake" type="text" placeholder="../../">
          <button @click="invokee()" class="bg-blue-500 rounded-md text-white text-lg font-bold mt-2 w-full">Load
            File</button>
        </div>
      </div>
      ...
      <div
        class="bg-slate-300 text-gray-600 max-h-56 overflow-auto text-white pb-4 h-fullshadow-md rounded px-3 pt-4 pb-1 mt-2">
